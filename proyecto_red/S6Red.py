...
Ejecuta el código "MiREdS6-Listas.py" y prueba las nuevas funciones de lista de amigos
 y muro para entender bien cómo funcionan. 
 Revisa y examina el código con atención para que no se te escape nada y 
 trata de extenderlo con los ejercicios 1 y 2 que te planteamos a continuación y 
 responde al cuestionario de evaluación. 

EJERCICIO 1

Agrega una opción que permita agregar un nuevo amigo a tu lista. 
Esta funcionalidad solamente agregará al usuario, sin pedir autorización
 y aceptación por parte del destinatario como hace Facebook. 
 Es decir, que la relación de amistad solamente existe en un sentido. 

EJERCICIO 2

Agrega una opción que permita mostrar los últimos estados de todos los amigos de un usuario.
 Ten en cuenta que esto no es equivalente a publicar los mensajes de su muro,
   sino que necesitarás leer una línea particular de los archivos de
     cada usuario en su lista de amigos. 
